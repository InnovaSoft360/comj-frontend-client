...
_s(EditApplicationModal, "bnpD/XS6LZswhGgpdjkVJV2ebVY=", false, function() {
    return [
...
function Candidatura() {
    _s();
    const { application, isLoading, hasApplication, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApplication$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApplication"])();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const shouldShowEditButton = hasApplication && (application === null || application === void 0 ? void 0 : application.status) === 4 && application.allowRejectedEdit; // Apenas Rejeitada com permissão para editar
    // Status onde NENHUM botão aparece
    const shouldHideAllButtons = hasApplication && ((application === null || application === void 0 ? void 0 : application.status) === 1 || // Pendente
    (application === null || application === void 0 ? void 0 : application.status) === 2 || // Em Análise
    (application === null || application === void 0 ? void 0 : application.status) === 3 || // Aprovada
    (application === null || application === void 0 ? void 0 : application.status) === 5 || (application === null || application === void 0 ? void 0 : application.status) === 4 && !application.allowRejectedEdit); // Rejeitada sem permissão
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                (application.status === 1 || application.status === 2) && application.remainingDays > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Candidatura, "544p8UG6TF+ZcczTN0ewzXp5eqA=", false, function() {
    return [
