...
;
// SEMPRE usa o hostname do PC/servidor
const getBackendURL = ()=>{
    // No servidor (SSR) ou configuração explícita
    if (process.env.NEXT_PUBLIC_API_URL) {
        return process.env.NEXT_PUBLIC_API_URL;
    }
    // No cliente, SEMPRE conecta no PC/servidor
    return 'https://nascimento:7209';
};
...
const API_CONFIG = {
    baseURL: process.env.NEXT_PUBLIC_API_URL || 'https://nascimento:7209'
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93ac6ebf._.js.map