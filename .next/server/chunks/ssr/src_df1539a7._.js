...
"[project]/src/hooks/useApplicationData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useApplicationData = ()=>{
    ...
    const getCurrentApplicationData = async (applicationId)=>{
        try {
            setIsLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/v1/Applications/GetById?ApplicationId=${applicationId}`);
            if (response.data.code === 200 && response.data.data) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApplicationData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useApplicationData.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$customAlert$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/customAlert.tsx [app-ssr] (ecmascript)");
'use client';
;
;
...
function EditApplicationModal({ application, onClose, onSuccess }) {
    ...
    const { getCurrentApplicationData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApplicationData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useApplicationData"])();
    const { showAlert, AlertContainer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$customAlert$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAlert"])();
    const [fileData, setFileData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        documentIdCardUrl: null,
        documentSalaryDeclarationUrl: null,
    ...
    const handleFileChange = (field, file)=>{
        console.log('📁 Arquivo selecionado:', field, file?.name);
        const newFileData = {
            ...fileData,
            [field]: file
        };
...
//# sourceMappingURL=src_df1539a7._.js.map